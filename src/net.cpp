...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LitecoinX " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.litecoinx.com", "108.61.196.125"},
    {"seed2.litecoinx.com", "114.215.110.130"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LitecoinX is probably already running."), addrBind.ToString().c_str());
        else
